 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'tungnsqb.sell_api1.gmail.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '3XF63VG6A3QYCWTC' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AaEv.5VETUO4DgKvwFJZG.h0cTFnAiAfuczbOkKNAtXfm3bu98nH-QT0' : 'PRODUCTION_SIGNATURE_GOES_HERE';
/*
 ...
 */
$config['DeveloperEmailAccount'] = 'tungnsqb.sell-facilitator@gmail.com';
/**
